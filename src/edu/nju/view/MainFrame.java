...
public class MainFrame implements Observer {
	...
	public MainFrame() {
		try {
			UIManager                       //程序在哪个平台运行,显示的窗口,对话框外观将是哪个平台的外观.
	...
	public void update(Observable o, Object arg) {
		...
		}else if(notifingObject.getKey().equals("end")){                      //Over
			timer.stop();
			if(notifingObject.getGameResult().equals(GameResultState.FAIL)){
			body.setBorder(new javax.swing.border.TitledBorder(
					new javax.swing.border.TitledBorder(""), "Lose~ Bye",
					javax.swing.border.TitledBorder.CENTER,
					javax.swing.border.TitledBorder.DEFAULT_POSITION));
			startButton.setIcon(Images.START_END);
			}
			if(notifingObject.getGameResult().equals(GameResultState.SUCCESS)){
				body.setBorder(new javax.swing.border.TitledBorder(
						new javax.swing.border.TitledBorder(""), "Success~ Yeah",
						javax.swing.border.TitledBorder.CENTER,
						javax.swing.border.TitledBorder.DEFAULT_POSITION));
				startButton.setIcon(Images.START_SUCCESS);
				}
