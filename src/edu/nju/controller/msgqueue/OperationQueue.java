...
public class OperationQueue implements Runnable{
	...
	public static void changBoardModel(ChessBoardModelService chessBoardModelProxy) {
		// TODO Auto-generated method stub
		chessBoard = chessBoardModelProxy;
	}

	public static void changGameModel(GameModelProxy gameProxy) {
		// TODO Auto-generated method stub
		gameModel = gameProxy;
	}
